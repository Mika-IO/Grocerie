...
import { IonIcon, IonGrid, IonSearchbar, IonToolbar, IonRow, IonCol, IonBackButton, IonButton, IonButtons, IonTitle, IonHeader, IonBadge } from '@ionic/react';
  ...
  return (
	  ...
	  <IonToolbar>
        ...
        <IonBackButton defaultHref="home"></IonBackButton>
          ...
          <IonButton>
            <IonIcon className="header-icon" color="primary" icon={cartSharp} />
          </IonButton>
          <IonButton>
            <IonIcon className="header-icon" color="primary" icon={cardSharp} />
          </IonButton>
        </IonButtons>
	    ...
	    <IonSearchbar placeholder="Pesquisar produtos..." searchIcon={ searchOutline } animated={ true } ></IonSearchbar> 
